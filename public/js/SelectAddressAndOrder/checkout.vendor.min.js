...
!(function (n, t) {
  ...
  function cf(n, t, u) {
    ...
    if (0 >= f || null == f) {
      if (
        ((f = p(n, t, e)), (0 > f || null == f) && (f = n.style[t]), pt.test(f))
      )
        return f;
  ...
  i.fn.extend({
    ...
    is: function (n) {
      return !!ri(this, "string" == typeof n && ar.test(n) ? i(n) : n || [], !1)
        .length;
    },
  });
  yr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    ...
    closest: function (n, t) {
      for (
        var r,
          ...
          o = this.length,
          u = [],
          e = ar.test(n) || "string" != typeof n ? i(n, t || this.context) : 0;
        o > f;
        f++
      )
      ...
      return arguments.length
        ...
        ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
          t && "get" in t && void 0 !== (r = t.get(u, "value"))
            ? r
            : ((r = u.value),
              "string" == typeof r ? r.replace(pf, "") : null == r ? "" : r))
        : void 0;
    },
  });
  i.extend({
  ...
  return (
    ...
    (i.offset = {
      setOffset: function (n, t, r) {
        ...
        c = i.css(n, "left");
        v =
          ("absolute" === l || "fixed" === l) && i.inArray("auto", [s, c]) > -1;
        v
...
!(function (n) {
          ...
          function (n, t, i) {
            ...
            return (
              ...
              (r.prototype.render = function () {
                ...
                return (
                  n[0].classList.add("select2-selection--single"),
                  n.html(
          ...
          function (n, t, i) {
            ...
            return (
              ...
              (r.prototype.render = function () {
                var n = r.__super__.render.call(this);
                return (
                  n[0].classList.add("select2-selection--multiple"),
              ...
              (r.prototype.update = function (n) {
                ...
                if ((this.clear(), 0 !== n.length)) {
                  for (
                    ...
                    r.find(".select2-selection__choice__display")
                      .append(l)
                      .attr("id", e);
                    o = t.title || t.text;
                    o && r.attr("title", o);
          ...
          function (n, t, i) {
            ...
            return (
              ...
              (r.prototype.resizeSearch = function () {
                ...
                var n = "100%";
                "" === this.$search.attr("placeholder") &&
                  (n = 0.75 * (this.$search.val().length + 1) + "em");
          ...
          function (n, t, i) {
            ...
            return (
                ...
                this.$element.prop("multiple")
                  ? this.current(function (i) {
                      var u = [],
                        r,
                        f;
                      for ((n = [n]).push.apply(n, i), r = 0; r < n.length; r++)
                        (f = n[r].id), -1 === u.indexOf(f) && u.push(f);
                      t.$element.val(u);
              ...
              (r.prototype.item = function (n) {
                ...
                if (((u = n[0]), "option" === u.tagName.toLowerCase()))
                  r = {
                    id: n.val(),
                    text: n.text(),
                  ...
                  for (
                    var e = n.children("option"), o = [], f = 0;
                    f < e.length;
                    f++
                  )
                    (s = i(e[f])), (h = this.item(s)), o.push(h);
                  r.children = o;
                }
                return (
              ...
              (r.prototype.convertToOptions = function (n) {
                ...
                for (
                  ...
                  if (((t = this._normalizeItem(n[r])), 0 <= c.indexOf(t.id))) {
                    ...
                    (u = this.option(t)),
                      t.children &&
                        ((s = this.convertToOptions(t.children)), u.append(s)),
                      e.push(u);
                return e;
              }),
              r
              ...
              i.on("results:all", function (n) {
                (null != n.query.term && "" !== n.query.term) ||
                  (u.showSearch(n)
                    ...
                    : u.$searchContainer[0].classList.add(
                        "select2-search--hide"
                      ));
              });
              i.on("results:focus", function (n) {
              ...
              (st.prototype.apply = function (c) {
                ...
                for (
                  ...
                  null == c.dropdownAdapter) &&
                    (c.multiple
                      ? (c.dropdownAdapter = g)
                      : ((ct = h.Decorate(g, nt)), (c.dropdownAdapter = ct)),
                    ...
                    null != c.dropdownCssClass &&
                      (c.dropdownAdapter = h.Decorate(c.dropdownAdapter, ot)),
  ...
  function () {
    ...
    TurboGraft.getTGAttribute = function (n, t) {
      var i;
      return (
        (i = TurboGraft.tgAttribute(t)), n.getAttribute(i) || n.getAttribute(t)
      );
    };
    TurboGraft.removeTGAttribute = function (n, t) {
      var i;
      return (
        (i = TurboGraft.tgAttribute(t)),
        n.removeAttribute(i),
        n.removeAttribute(t)
      );
    };
    TurboGraft.hasTGAttribute = function (n, t) {
      var i;
      return (
        (i = TurboGraft.tgAttribute(t)), n.hasAttribute(i) || n.hasAttribute(t)
      );
    };
    TurboGraft.querySelectorAllTGAttribute = function (n, t, i) {
      ...
      return (
        ...
        i
          ? n.querySelectorAll("[" + r + "=" + i + "], [" + t + "=" + i + "]")
          : n.querySelectorAll("[" + r + "], [" + t + "]")
      );
    };
  }.call(this),
  function () {
    window.Click = (function () {
      function n(n) {
        ...
        this.event.defaultPrevented ||
          (this._extractLink(),
          this._validForTurbolinks() &&
            (Turbolinks.visit(this.link.href), this.event.preventDefault()));
      }
      return (
        (n.installHandlerLast = function (t) {
          if (!t.defaultPrevented)
            return (
              document.removeEventListener("click", n.handle, !1),
        ...
        (n.prototype._validForTurbolinks = function () {
          return (
            null != this.link &&
            !(this.link.shouldIgnore() || this._nonStandardClick())
          );
        }),
  ...
  function () {
    window.ComponentUrl = (function () {
      function n(t) {
        if (
          ((this.original = null != t ? t : document.location.href),
      ...
      return (
        (n.prototype.withoutHash = function () {
        ...
        (n.get = function (n) {
          ...
          return (
            null == n && (n = document),
            {
              ...
              token:
                null != t && "function" == typeof t.getAttribute
  ...
  function () {
    TurboGraft.Document = {
      create: function (n) {
        ...
        return (
          /<(html|body)/i.test(n)
            ? ((t = document.documentElement.cloneNode()).innerHTML = n)
            : ((t = document.documentElement.cloneNode(!0)).querySelector(
                "body"
              ).innerHTML = n),
  ...
  function () {
    ...
    n = function (n, t, i) {
      ...
      if (
        ...
        throw new Error(
          "Turbograft developer error: You did not provide a URL ('" +
            urlAttribute +
            "' attribute) for data-tg-remote"
        );
      return (
        TurboGraft.getTGAttribute(n, "remote-once") &&
          (TurboGraft.removeTGAttribute(n, "remote-once"),
        ...
        (u = {
          ...
          refreshOnSuccessExcept: TurboGraft.getTGAttribute(
            n,
            "full-refresh-on-success-except"
          ),
          refreshOnError: TurboGraft.getTGAttribute(n, "refresh-on-error"),
          refreshOnErrorExcept: TurboGraft.getTGAttribute(
            n,
    ...
    TurboGraft.handlers.remoteMethodHandler = function (t) {
      var r, i;
      i = t.clickTarget;
      (r = TurboGraft.getTGAttribute(i, "tg-remote")) &&
        (t.preventDefault(), n(i, r).submit());
    };
    (TurboGraft.handlers.remoteFormHandler = function (t) {
      var r, i;
      r = (i = t.target).getAttribute("method");
      TurboGraft.hasTGAttribute(i, "tg-remote") &&
        (t.preventDefault(), n(i, r, i).submit());
    }),
      (function (n, t, r) {
        null == r && (r = !1);
        document.addEventListener(n, function (n) {
          for (var u, r = n.target; r !== document && null != r; ) {
            if (
              ("A" === r.nodeName || "BUTTON" === r.nodeName) &&
              ((u = i(r)) && n.preventDefault(), !u)
            )
              return (n.clickTarget = r), void t(n);
            r = r.parentNode;
          }
        });
    ...
    window.Link = (function (t) {
      ...
      return (
        ...
        (r.allowExtensions = function () {
          for (
            var t,
              u,
              n = 0,
              f = (u = 1 <= arguments.length ? i.call(arguments, 0) : [])
                .length;
            n < f;
            n++
          )
            (t = u[n]), r.HTML_EXTENSIONS.push(t);
        ...
        (r.prototype._anchored = function () {
          var n;
          return (
            (this.hash && this.withoutHash()) ===
              (n = new ComponentUrl()).withoutHash() ||
            this.href === n.href + "#"
          );
        }),
        (r.prototype._nonHtml = function () {
          return (
            this.pathname.match(/\.[a-z]+$/g) &&
            !this.pathname.match(
              new RegExp("\\.(?:" + r.HTML_EXTENSIONS.join("|") + ")?$", "g")
            )
          );
        }),
  ...
  function () {
    ...
    Page.refresh = function (n, t) {
      ...
      return (
        ...
        (f = n.response)
          ? Turbolinks.loadPage(null, f, r)
          : Turbolinks.visit(u, r)
      );
    };
    Page.open = function () {
    ...
    Page.onReplace = function (t, r) {
      if (!t || !r)
        throw new Error(
          "Page.onReplace: Node and callback must both be specified"
        );
  ...
  function () {
    ...
    TurboGraft.Remote = (function () {
      function t(t, i, r) {
        ...
        this.initiator = i || r;
        this.actualRequestType =
          "get" ===
          (null != (e = this.opts.httpRequestType) ? e.toLowerCase() : void 0)
            ? "GET"
            : "POST";
        this.useNativeEncoding = this.opts.useNativeEncoding;
        this.formData = this.createPayload(i);
        this.opts.refreshOnSuccess &&
          (this.refreshOnSuccess = this.opts.refreshOnSuccess.split(" "));
        this.opts.refreshOnSuccessExcept &&
          (this.refreshOnSuccessExcept =
            this.opts.refreshOnSuccessExcept.split(" "));
        this.opts.refreshOnError &&
          (this.refreshOnError = this.opts.refreshOnError.split(" "));
        this.opts.refreshOnErrorExcept &&
          (this.refreshOnErrorExcept =
            this.opts.refreshOnErrorExcept.split(" "));
        u = new XMLHttpRequest();
        "GET" === this.actualRequestType
          ? ((o = this.formData
              ? this.opts.httpUrl + "?" + this.formData
              : this.opts.httpUrl),
            u.open(this.actualRequestType, o, !0))
          : u.open(this.actualRequestType, this.opts.httpUrl, !0);
        ...
        this.contentType &&
          u.setRequestHeader("Content-Type", this.contentType);
        ...
        u.addEventListener(
          ...
          (function (n) {
            return function () {
              var t;
              return (
                "function" == typeof (t = n.opts).done && t.done(),
      ...
      return (
        ...
        (t.prototype.createPayload = function (n) {
          ...
          return (
            (t = n
              ? this.useNativeEncoding ||
                n.querySelectorAll("[type='file'][name]").length > 0
                ? this.nativeEncodeForm(n)
                : this.uriEncodeForm(n)
              : "") instanceof FormData ||
              ((this.contentType =
                "application/x-www-form-urlencoded; charset=UTF-8"),
              -1 === t.indexOf("_method") &&
                this.opts.httpRequestType &&
                "GET" !== this.actualRequestType &&
                (t = this.formAppend(t, "_method", this.opts.httpRequestType))),
            t
          );
        }),
        ...
        (t.prototype.formDataAppend = function (n, t) {
          var r, i, u, f;
          if ("file" === t.type)
            for (i = 0, u = (f = t.files).length; i < u; i++)
              (r = f[i]), n.append(t.name, r);
        ...
        (t.prototype._iterateOverFormInputs = function (n, t) {
          var r, i, e, o, s, f, u;
          for (
            u = [], r = 0, s = (o = this._enabledInputs(n)).length;
            r < s;
            r++
          )
            (e = !(i = o[r]).disabled),
              (f = "checkbox" === i.type || "radio" === i.type),
              e && i.name && ((f && i.checked) || !f)
                ? u.push(t(i))
                : u.push(void 0);
          return u;
        }),
        (t.prototype._enabledInputs = function (n) {
          ...
          if (
            ((s =
              "input:not([type='reset']):not([type='button']):not([type='submit']):not([type='image']), select, textarea"),
            (u = Array.prototype.slice.call(n.querySelectorAll(s))),
            !(i = Array.prototype.slice.call(
              TurboGraft.querySelectorAllTGAttribute(n, "tg-remote-noserialize")
            )).length)
          )
            return u;
          for (t = i, r = 0, h = i.length; r < h; r++)
            (l = i[r]),
              (t = t.concat(Array.prototype.slice.call(l.querySelectorAll(s))));
          for (e = [], f = 0, c = u.length; f < c; f++)
            (o = u[f]), t.indexOf(o) < 0 && e.push(o);
          return e;
        }),
        (t.prototype.onSuccess = function (n) {
          var i, r, t;
          return (
            "function" == typeof (i = this.opts).success && i.success(),
            (t = n.target),
            triggerEventFor("turbograft:remote:success", this.initiator, {
              initiator: this.initiator,
              xhr: t,
            }),
            (r = t.getResponseHeader("X-Next-Redirect"))
              ? void Page.visit(r, { reload: !0 })
              : TurboGraft.hasTGAttribute(this.initiator, "tg-remote-norefresh")
              ? void 0
              : this.opts.fullRefresh && this.refreshOnSuccess
              ? Page.refresh({ onlyKeys: this.refreshOnSuccess })
              : this.opts.fullRefresh
              ? Page.refresh()
              : this.refreshOnSuccess
              ? Page.refresh({ response: t, onlyKeys: this.refreshOnSuccess })
              : this.refreshOnSuccessExcept
              ? Page.refresh({
                  response: t,
        ...
        (t.prototype.onError = function (n) {
          var i, t;
          return (
            "function" == typeof (i = this.opts).fail && i.fail(),
            (t = n.target),
            ...
            TurboGraft.hasTGAttribute(this.initiator, "tg-remote-norefresh")
              ...
              : this.opts.fullRefresh && this.refreshOnError
              ? Page.refresh({ onlyKeys: this.refreshOnError })
              : this.opts.fullRefresh
              ? Page.refresh()
              : this.refreshOnError
              ? Page.refresh({ response: t, onlyKeys: this.refreshOnError })
              : this.refreshOnErrorExcept
              ? Page.refresh({
                  response: t,
  ...
  function () {
    TurboGraft.Response = (function () {
      function n(n, t) {
        ...
        this.xhr = n;
        i =
          t && t.withoutHash() !== this.xhr.responseURL
            ? this.xhr.responseURL
            : this.xhr.getResponseHeader("X-XHR-Redirected-To");
        this.finalURL = i || t;
      }
      return (
  ...
  function () {
    ...
    TurboGraft.TurboHead = (function () {
      function c(n, t) {
        ...
        this.newScripts = this.upstreamAssets
          .filter(e("nodeName", "SCRIPT"))
          .filter(i("src", this.activeAssets));
        this.newLinks = this.upstreamAssets
          .filter(e("nodeName", "LINK"))
          .filter(i("href", this.activeAssets));
      }
      return (
        (c._testAPI = {
          reset: function () {
        ...
        (c.prototype.hasChangedAnonymousAssets = function () {
          var r, n, e, o;
          return (
            (n = this.upstreamAssets.filter(f(t, u))),
            (r = this.activeAssets.filter(f(t, u))).length !== n.length ||
              ((o = i("src", n)),
              (e = i("href", n)),
              r.some(function (n) {
                return o(n) || e(n);
        ...
        (c.prototype.movingFromTrackedToUntracked = function () {
          return (
            0 === this.upstreamAssets.length && this.activeAssets.length > 0
          );
        }),
        (c.prototype.hasNamedAssetConflicts = function () {
          return this.newScripts
            ...
            .filter(l(t, u))
            .some(h(t, this.activeAssets));
        }),
        (c.prototype.hasAssetConflicts = function () {
          return (
            this.movingFromTrackedToUntracked() ||
        ...
        (c.prototype.waitForAssets = function () {
          return (
            "function" == typeof r && r({ isCanceled: !0 }),
            new Promise(
              ((n = this),
              function (t) {
        ...
        (c.prototype._insertNewAssets = function () {
          return (
            a(this.activeDocument, this.newLinks),
    ...
    c = function (t, i) {
      ...
      for (
        r = t.createElement("SCRIPT"), u = 0, o = (s = i.attributes).length;
        u < o;
        u++
      )
        (e = s[u]), r.setAttribute(e.name, e.value);
      return (
        r.appendChild(t.createTextNode(i.innerHTML)),
        (n[f] = new Promise(function (n) {
          var i;
          return (
            (i = function (t) {
              return (
                "error" === t.type && triggerEvent("page:#script-error", t),
  ...
  function () {
    ...
    h =
      ...
      navigator.userAgent.match(/Firefox\/2[6|7]/);
    o =
      window.history &&
    ...
    v =
      "GET" ===
        (a = (function (t) {
          ...
          return (
            (r =
              (null != (i = n.cookie.match(new RegExp(t + "=(\\w+)")))
                ? i[1].toUpperCase()
                : void 0) || ""),
    ...
    r = function (n, t) {
      var i;
      return (
        (i = t.parentNode.replaceChild(n, t)),
    ...
    window.Turbolinks = (function () {
      ...
      return (
        ...
        (nt = function (n, t) {
          if ((null == t && (t = {}), !ft(n)))
            return (n = new ComponentUrl(n)), v(), tt(n, t);
        }),
        (ut = function (n, t) {
          var i, r;
          return Boolean(
            t.partialReplace ||
              (null != (i = t.onlyKeys) ? i.length : void 0) ||
              (null != (r = t.exceptKeys) ? r.length : void 0)
          );
        }),
        (i.fullPageNavigate = function (t) {
          null != t &&
            ((t = new ComponentUrl(t).absolute),
            triggerEvent("page:before-full-refresh", { url: t }),
            (n.location.href = t));
        }),
        ...
        (tt = function (n, r) {
          var u, f, e;
          for (u in (triggerEvent("page:fetch", { url: n.absolute }),
          null != t &&
            ((t.readyState = 0), (t.statusText = "abort"), t.abort()),
          (t = new XMLHttpRequest()).open(
            "GET",
            n.withoutHashForIE10compatibility(),
            !0
          ),
          t.setRequestHeader(
            "Accept",
          ...
          t.onload = function () {
            return (
              t.status >= 500 ? i.fullPageNavigate(n) : i.loadPage(n, t, r),
              (t = null)
            );
          };
          t.onerror = function () {
            return "abort" === t.statusText
              ? void (t = null)
              : i.fullPageNavigate(n);
          };
          t.send();
        }),
        (i.loadPage = function (t, r, u) {
          ...
          return (
            ...
            (s = o.document())
              ? u.partialReplace
                ? void p(s, o, u)
                : (h = new e(n, s)).hasAssetConflicts()
                ? i.fullPageNavigate(o.finalURL)
                : h.waitForAssets().then(function (n) {
        ...
        (p = function (n, t, r) {
          ...
          return (
            (u = k(
              null != (f = n.querySelector("title")) ? f.textContent : void 0,
              ht(n.querySelector("body")),
              CSRFToken.get(n).token,
              "runScripts",
              r
            )),
        ...
        (k = function (t, i, u, f, e) {
          ...
          a(c(), i);
          et(i);
          (null != (l = e.exceptKeys) ? l.length : void 0)
            ? st(e.exceptKeys, i)
            : d(i);
        ...
        (it = function (t) {
          ...
          for (u = [], i = 0, e = t.length; i < e; i++)
            for (
              f = t[i],
                r = 0,
                o = (h = TurboGraft.querySelectorAllTGAttribute(
                  n,
                  "refresh",
                  f
                )).length;
        ...
        (c = function () {
          ...
          for (
            i = [],
              t = 0,
              r = (f = TurboGraft.querySelectorAllTGAttribute(
                n,
                "refresh-always"
              )).length;
            t < r;
        ...
        (w = function (n) {
          for (var t = 0, i = n.length; t < i; t++)
            if (
              n[t].querySelectorAll("input[autofocus], textarea[autofocus]")
                .length > 0
            )
              return !0;
          return !1;
        ...
        (d = function (n) {
          for (
            var r,
              f,
              t = 0,
              i = (f = TurboGraft.querySelectorAllTGAttribute(
                n,
                "refresh-never"
              )).length;
            t < i;
        ...
        (a = function (n, t) {
          var f, e, s, i, c, l, o;
          for (
            triggerEvent("page:before-partial-replace", n),
              l = function (t) {
            ...
            if (!l((f = n[e]))) {
              if (!(c = f.getAttribute("id")))
                throw new Error(
                  "Turbolinks refresh: Refresh key elements must have an id."
                );
              (i = t.querySelector("#" + c))
                ? ((i = i.cloneNode(!0)),
                  r(i, f),
                  "SCRIPT" === i.nodeName &&
                  "false" !== i.dataset.turbolinksEval
                    ? h(i)
                    : o.push(i))
                : TurboGraft.hasTGAttribute(f, "refresh-always") || u(f);
            }
          return o;
        }),
        (l = function (n, t) {
          ...
          for (u = [], i = 0, e = t.length; i < e; i++) {
            if (!(o = (f = t[i]).getAttribute("id")))
              throw new Error(
                "TurboGraft refresh: Kept nodes must have an id."
              );
        ...
        (et = function (t) {
          ...
          for (
            r = [],
              i = 0,
              u = (e = TurboGraft.querySelectorAllTGAttribute(n, "tg-static"))
                .length;
            i < u;
            i++
          )
        ...
        (st = function (t, i) {
          ...
          for (f = [], r = 0, o = t.length; r < o; r++)
            for (
              e = t[r],
                u = 0,
                s = (c = TurboGraft.querySelectorAllTGAttribute(
                  n,
                  "refresh",
                  e
                )).length;
        ...
        (g = function () {
          for (
            var r,
              ...
              f,
              t = 0,
              i = (f = Array.prototype.slice.call(
        ...
        (h = function (t) {
          var u, i, r, e, o, f, s;
          for (
            i = n.createElement("script"), r = 0, e = (s = t.attributes).length;
            r < e;
            r++
          )
            (u = s[r]), i.setAttribute(u.name, u.value);
        ...
        (ot = function (n) {
          (n = new ComponentUrl(n)).absolute !== o &&
            i.pushState({ turbolinks: !0, url: n.absolute }, "", n.absolute);
        }),
        (v = function () {
        ...
        (i.rememberCurrentUrl = function () {
          return i.replaceState(
            { turbolinks: !0, url: n.location.href },
            "",
            n.location.href
          );
        }),
        ...
        (i.resetScrollPosition = function () {
          return n.location.hash
            ? (n.location.href = n.location.href)
            : window.scrollTo(0, 0);
        }),
        (ft = function (n) {
  ...
  function () {
    var n = [].slice;
    (function (n, t) {
      return typeof n.define == "function" && n.define.amd
        ? n.define([], t)
      ...
      for (
        t = {},
          ...
          d = function (n, i, u, f) {
            ...
            if (
              ...
              u == null && (u = {});
              for (nt in u)
                (ii = u[nt]), ut.hasOwnProperty(nt) || (ut[nt] = ii);
              u = ut;
              e = c(i);
              e.indexes = u;
            }
            for (
              h = null, ct = i.attributes, k = 0, dt = ct.length;
              k < dt;
              k++
            )
              ((et = ct[k]),
              ...
              lt(a) && (a = a.slice(5)),
              (p = t.bindingTypes[a]),
              p) && (h == null && (h = []), (w = et.value), h.push([a, p, w]));
            if (h)
              for (
                e == null && (e = c(i)),
            ...
            for (
              (rt = t.getAttribute(i, "context")) &&
                ((l = v(i, rt)),
                l[0] === "$root" && ((n = r), (l = l.slice(1))),
                (n = s(n, l) || b(n, l, {}))),
                (e || rt || f) &&
                  (e == null && (e = c(i)),
                  (e.childContext = n),
              ...
              (bt = vt[tt]), d(n, bt, rt != null ? null : u);
            for (
              t.count = y, yt = wt || [], it = 0, ti = yt.length;
              it < ti;
              it++
            )
              (pt = yt[it]), pt();
          ...
          c = function (n) {
            var t;
            return (
              n.bindingId == null && (n.bindingId = ++y),
              i[(t = n.bindingId)] != null ? i[t] : (i[t] = {})
            );
          },
          t.refresh = function (n) {
            if ((n && p.push(n), !w))
              return (w = !0), setTimeout(t.refreshImmediately, 0);
          },
          wt = function (n) {
            var t, u, i, r;
            if (n.bindings)
              for (r = n.bindings, t = 0, u = r.length; t < u; t++)
                (i = r[t]), i.refresh != null && i.refresh();
          },
          t.refreshImmediately = function () {
            var t, r, u, n, f, e;
            w = !1;
            for (f in i) (u = i[f]), wt(u);
            for (t = p, p = [], n = 0, e = t.length; n < e; n++)
              (r = t[n]), r();
          },
          t.register = function (n, t) {
            if (h[n])
              throw new Error(
                "Twine error: '" + n + "' is already registered with Twine"
              );
            else return (h[n] = t);
          },
            ...
            if ((e = n.bindingId)) {
              if ((f = (a = i[e]) != null ? a.bindings : void 0))
                for (r = 0, c = f.length; r < c; r++)
                  (o = f[r]), o.teardown && o.teardown();
              delete i[e];
              delete n.bindingId;
            }
            for (s = n.children || [], u = 0, l = s.length; u < l; u++)
              (h = s[u]), t.unbind(h);
            return this;
          },
          ...
          nt = function (n, t) {
            for (var u, f, o; n; ) {
              ...
              if (
                (f = n.bindingId) &&
                (u = (o = i[f]) != null ? o.childContext : void 0)
              )
                return u;
              t && (n = n.parentNode);
            }
          ...
          t.contextKey = function (n, t) {
            for (
              ...
              (s = n.bindingId) &&
                (o = (h = i[s]) != null ? h.childContext : void 0) &&
                u(o);
          ...
          gt = function (n) {
            ...
            return (
              ...
              t === "input" || t === "textarea" || t === "select"
                ? (i = n.getAttribute("type")) === "checkbox" || i === "radio"
                  ? "checked"
                  : "value"
                : "textContent"
            );
          ...
          v = function (n, t) {
            ...
            for (
              ...
              if (((t = o[r]), (u = t.indexOf("[")) !== -1))
                for (
                  r === 0
                    ? i.push.apply(i, it(t.substr(0, u), n))
                    : i.push(t.substr(0, u)),
                    t = t.substr(u);
                  (f = t.indexOf("]")) !== -1;

                )
                  i.push(parseInt(t.substr(1, f), 10)), (t = t.substr(f + 1));
          ...
          rt = function (n) {
            ...
            return (
              n.bindingId != null &&
              ((t = i[n.bindingId]) != null ? t.indexes : void 0)
            );
          },
          f = function (n, t) {
            var f, i, r, u;
          ...
          t.bindingTypes = {
            bind: function (n, i, e) {
              ...
              if (
                ...
                (y = function () {
                  var t;
                  if (((t = nt.call(n, i, r, f(n, i))), t !== a))
                    return ((a = t), t === n[h])
                      ? void 0
                      : ((n[h] = l ? t === n.value : t), g(n));
                }),
                !tt(e))
              )
                return { refresh: y };
            ...
            "bind-show": function (n, t, i) {
              var o, e;
              return (
                (o = u(i, "$context,$root,$arrayPointers", n)),
                (e = void 0),
                {
                  refresh: function () {
                    var i;
                    if (((i = !o.call(n, t, r, f(n, t))), i !== e))
            ...
            "bind-class": function (n, t, i) {
              var e, s, o;
              return (
                (s = u(i, "$context,$root,$arrayPointers", n)),
                (o = {}),
                (e = jQuery(n)),
                {
                  refresh: function () {
              ...
              return (
                ...
                (e = {}),
                {
                  refresh: function () {
                    ...
                    for (i in u)
                      (s = u[i]), e[i] !== s && jQuery(n).attr(i, s || null);
                    return (e = u);
                  },
                }
              );
          ...
          et = function (n, i) {
            ...
            return (
              ...
              (t.bindingTypes["bind-" + i.toLowerCase()] = function (t, i, o) {
                var h, s;
                return (
                  (h = u(o, "$context,$root,$arrayPointers", t)),
                  (s = void 0),
                  {
                    refresh: function () {
                      var u;
                      if (
                        ((u = h.call(t, i, r, f(t, i))),
                        e && (u = !!u),
                        u !== s)
                      )
                        return (t[n] = s = u), n === "checked" ? g(t) : void 0;
                    },
                  }
                );
              })
        ...
        (k = ut[l]), et(k, k);
      for (
        et("innerHTML", "unsafe-html"),
          pt = function (n) {
            var i;
            return (
              (n.type === "submit" ||
                n.currentTarget.nodeName.toLowerCase() === "a") &&
              ((i = t.getAttribute(n.currentTarget, "allow-default")) ===
                "false" ||
                i === !1 ||
                i === 0 ||
                i === void 0 ||
          ...
          kt = function (n) {
            return (t.bindingTypes["bind-event-" + n] = function (i, e, o) {
              var s = function (s, h) {
                ...
                if (
                  ((c =
                    typeof (l = t.shouldDiscardEvent)[n] == "function"
                      ? l[n](s)
                      : void 0),
                  ...
                  return (
                    u(o, "$context,$root,$arrayPointers,event,data", i).call(
                      i,
                      e,
                      r,
                      f(i, e),
