...
$slug = $_REQUEST['bra'];
$bralistid = $brand->brand_id($slug);
$categoryid = $category->category_id($slug);
$braname = $brand->brand_row($slug);
$listproduct = $product->product_brand($bralistid, $categoryid);
...
<section class="page margin-top-30 margin-bottom-30">
  <ul class="breadcrumb align-items-center pl-0 pr-0 m-0">
    ...
    <li class="font-weight-bold">Trang thương hiệu <?php echo $braname['name']; ?></li>
  </ul>
  <div class="container">
    <!--end slider-->
