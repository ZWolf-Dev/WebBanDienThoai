                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <fieldset class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" value="" name="fullname"
                                    id="fullname" placeholder="Họ và tên" required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Tên đăng nhập <span class="required">*</span></label>
                                <input type="text" class="form-control form-control-lg" value="" name="username"
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" pattern="[0-1]" class="form-control form-control-lg" value=""
                                    name="gender" id="gender" placeholder="Nữ nhập 0, Nam nhập 1" required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Số điện thoại <span class="required">*</span></label>
                                <input placeholder="Số điện thoại" type="text" pattern="\d+" id="Phone"
                                    class="form-control form-control-comment form-control-lg" name="Phone" Required>
                            </fieldset>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
