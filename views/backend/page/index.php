              ...
              <tr>
                ...
                <td class="text-center">
                  <?php if ($post_row['status'] == 1) : ?>
                    <a href="index.php?option=page&cat=status&id=<?php echo $post_row['id']; ?>" class="btn btn-sm btn-success"><i class="fas fa-toggle-on"></i></a>
                  <?php else : ?>
                    <a href="index.php?option=page&cat=status&id=<?php echo $post_row['id']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-toggle-off"></i></a>
                  <?php endif; ?>
                  <a href="index.php?option=page&cat=update&id=<?php echo $post_row['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                  <a href="index.php?option=page&cat=deltrash&id=<?php echo $post_row['id']; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                </td>
