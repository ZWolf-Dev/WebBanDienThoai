                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="index.php?option=page" class="btn btn-sm btn-success">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <fieldset class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" value="" name="title" id="title"
                                    required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Chi tiết bài viết<span class="required">*</span> </label>
                                <input type="text" class="form-control form-control-lg" value="" name="detail" id="detail"
                                     required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Từ khóa SEO<span class="required">*</span> </label>
                                <input type="text" class="form-control form-control-lg" value="" name="metakey"
                                    id="metakey" required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Mô tả SEO<span class="required">*</span> </label>
                                <input type="text" class="form-control form-control-lg" value="" name="metadesc"
                                    id="metadesc"  required>
                            </fieldset>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
